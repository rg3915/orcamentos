# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-23 02:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.CharField(blank=True, max_length=50, verbose_name='empresa')),
                ...
                ('rg', models.CharField(blank=True, max_length=11, verbose_name='RG')),
                ('cnpj', models.CharField(blank=True, max_length=14, unique=True, verbose_name='CNPJ')),
                ('ie', models.CharField(blank=True, max_length=12, verbose_name='inscrição estadual')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_type', models.CharField(choices=[('c', 'cliente'), ('p', 'contato')], default='p', max_length=1, verbose_name='cliente ou contato')),
                ('customer_type', models.CharField(blank=True, choices=[('c', 'construtora'), ('a', 'arquitetura'), ('p', 'particular')], max_length=1, verbose_name='tipo de cliente')),

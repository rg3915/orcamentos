...
class Customer(MyUser, People):
    ...
    def get_absolute_url(self):
        return reverse_lazy('core:customer_detail', kwargs={'pk': self.pk})
...
class Entry(TimeStampedModel):
    ...
    def get_absolute_url(self):
        return reverse_lazy('core:entry_detail', kwargs={'pk': self.pk})
...
class Work(Address):
    ...
    def get_absolute_url(self):
        return reverse_lazy('core:work_detail', kwargs={'pk': self.pk})
...
class Proposal(TimeStampedModel):
    ...
    def get_absolute_url(self):
        return reverse_lazy('core:proposal_detail', kwargs={'pk': self.pk})
...
class Contract(TimeStampedModel):
    ...
    def get_absolute_url(self):
        return reverse_lazy('core:contract_detail', kwargs={'pk': self.pk})

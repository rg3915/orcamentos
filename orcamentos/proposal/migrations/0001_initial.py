    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modificado em')),
                ('priority', models.CharField(choices=[(1, 'Urgente'), (2, 'Alta'), (3, 'Normal'), (4, 'Baixa')], default=3, max_length=10, verbose_name='prioridade')),
                ('category', models.PositiveIntegerField(default=1, verbose_name='categoria')),
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entry_seller', to='crm.Seller', verbose_name='vendedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prop_type', models.CharField(blank=True, choices=[('R', 'R'), ('OP', 'OP')], max_length=20, null=True, verbose_name='tipo de orçamento')),
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proposal_person', to='crm.Person', verbose_name='contato')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proposal_seller', to='crm.Seller', verbose_name='vendedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_person', to='crm.Person', verbose_name='contato')),
            ],
            options={
